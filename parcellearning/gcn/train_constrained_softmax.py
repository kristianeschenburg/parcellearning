...
def main(args):
    ...
    train_adj = train_weight[Y_train]
    ...
    for epoch in range(args.num_epochs):
        ...
        train_logits = F.softmax(train_logits*train_adj, dim=1)
        ...
        train_loss = entropy_loss(train_logits, Y_train)
        ...
        with th.no_grad():
            ...
            val_loss = entropy_loss(val_logits, Y_val)
